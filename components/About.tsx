...
export default function About({ }: Props) {
    return (
        <div className='flex flex-col relative text-center h-screen md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <h3 className='absolute top-24 bottom-24 uppercase text-gray-500 text-2xl tracking-wide hover:text-cyan-400 '>
                About
            </h3>
            ...
            <motion.img
                ...
                alt="my picture"
                className='relative top-28 md:top-0 sm:mt-20 mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:w-64 md:h-54 md:rounded-lg border border-cyan-100'
            />
            
            <div className="space-y-10 px-0 md:px-10 mt-7 md:mt-0">
