...
export default function About({ }: Props) {
    return (
        <div className='flex flex-col relative text-center h-screen md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <h3 className='absolute top-24 bottom-24 uppercase tracking-[20px] text-gray-500 text-2xl '>
                About
            </h3>
            ...
            <motion.img
                ...
                alt="my picture"
                className='sm:mt-20 mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64'
            />
            </div>
